...
function renderLayout(){
	...
	//]]> 
	loadCSS('//bizweb.dktcdn.net/100/426/076/themes/917889/assets/fonts.css?1692084315105')
	//Bizweb
	awe.init = function () {
		awe.showPopup();
		awe.hidePopup();	
	...
	$.getScript('//bizweb.dktcdn.net/100/426/076/themes/917889/assets/vendors.js?1692084315105').then(()=>{
				$('#mc-form').ajaxChimp({
		language: 'en',
