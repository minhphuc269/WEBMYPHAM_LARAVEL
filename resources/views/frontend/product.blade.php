                                ...
                                <aside class="aside-item filter-vendor">
                                    ...
                                    <div class="aside-content filter-group scroll">
                                        <ul class="price-list ml-3">
                                            <li>
                                                <a
                                                    href="{{ route('site.product.index', ['price_range' => '0-100000']) }}">
                                                    Dưới 100.000đ
                                                </a>
                                            </li>
                                            <li>
                                                <a
                                                    href="{{ route('site.product.index', ['price_range' => '100000-200000']) }}">
                                                    100.000đ - 200.000đ
                                                </a>
                                            </li>
                                            <li>
                                                <a
                                                    href="{{ route('site.product.index', ['price_range' => '200000-300000']) }}">
                                                    200.000đ - 300.000đ
                                                </a>
                                            </li>
                                            <li>
                                                <a
                                                    href="{{ route('site.product.index', ['price_range' => '300000-500000']) }}">
                                                    300.000đ - 500.000đ
                                                </a>
                                            </li>
                                        </ul>
