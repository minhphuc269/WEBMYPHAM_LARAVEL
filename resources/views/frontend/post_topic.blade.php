...
@section('title', 'Tin tức theo chủ đề: ' . $topic->name)
@section('content')
<div class="subheader">
    <div class="container">
        <x-menu-list-cate />
        ...
        <div class="row">
            <div class="col-12 a-left">
                <ul class="breadcrumb m-0 px-0">
                    ...
                    <li><strong><span>{{ $topic->name }}</span></strong></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="container card py2">
                <div class="row">
                    <div class="col-lg-9 col-12 py-3 content-blog">
                        <h1 class="title_page mb-3"> {{ $topic->name }}</h1>
                        <div class="row">
                    ...
                    <div class="col-lg-3 col-12 left-content sidebar mt-5">
                        <aside class="aside-item blog-sidebar sidebar-category margin-bottom-25">
                            <div class="aside-title">
                                <h2 class="title-head margin-top-0 cate"><span>Tin tức theo chủ đề</span></h2>
                            </div>
