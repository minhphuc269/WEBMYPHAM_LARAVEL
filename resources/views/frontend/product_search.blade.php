        ...
        <div class="row">
            <div class="col-12 a-left">
                <ul class="breadcrumb m-0 px-0">
                    ...
                    <li>
                        <strong><span> Kết quả tìm kiếm</span></strong>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                                ...
                                <aside class="aside-item filter-vendor">
                                    ...
                                    <div class="aside-content filter-group scroll">
                                        <ul class="price-list ml-3">
                                            <li>
                                                <a
                                                    href="{{ route('site.product.search', ['search' => $search, 'price_range' => '0-100000']) }}">
                                                    Dưới 100.000đ
                                                </a>
                                            </li>
                                            <li>
                                                <a
                                                    href="{{ route('site.product.search', ['search' => $search, 'price_range' => '100000-200000']) }}">
                                                    100.000đ - 200.000đ
                                                </a>
                                            </li>
                                            <li>
                                                <a
                                                    href="{{ route('site.product.search', ['search' => $search, 'price_range' => '200000-300000']) }}">
                                                    200.000đ - 300.000đ
                                                </a>
                                            </li>
                                            <li>
                                                <a
                                                    href="{{ route('site.product.search', ['search' => $search, 'price_range' => '300000-500000']) }}">
                                                    300.000đ - 500.000đ
                                                </a>
                                            </li>
                                        </ul>
                ...
                <div class="card py-2 main_container collection col-xl col-md-12 col-sm-12">
                    <h1 class="title_page collection-title mb-0">
                        Có {{ $count }} kết quả tìm kiếm phù hợp cho "{{ $search }}"
                    </h1>
                    <div class="category-product product">
                        ...
                        <div class="product-view product-view-grid collection_reponsive list_hover_pro">
                        ...
                        <script>
                            function sortby(sortType) {
                                var url = "{{ route('site.product.search', ['search' => $search]) }}";
