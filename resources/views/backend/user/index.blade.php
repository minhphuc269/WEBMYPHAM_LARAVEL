      ...
      <table class="table table-bordered table-hover table-striped">
        ...
        @endphp
          ...
          @endif
              ...
              <a href="{{ route("admin.user.show",$arg) }}" class="btn btn-xs btn-info" >
                <i class="fas fa-eye"></i>
              </a>
              <a href="{{ route("admin.user.edit",$arg) }}" class="btn btn-xs btn-primary" >
                <i class="fas fa-edit"></i>
              </a>
              <a href="{{ route('admin.user.delete', $arg) }}" class="btn btn-xs btn-danger">
                <i class="fas fa-trash"></i>
            </a>
            </td>
  ...
  document.addEventListener('DOMContentLoaded', function() {
      document.querySelectorAll('.toggle-status').forEach(function(button) {
          button.addEventListener('click', function() {
              ...
              fetch(`{{ url('admin/user/status/') }}/${userId}`, { 
                  method: 'GET',
                  headers: {
