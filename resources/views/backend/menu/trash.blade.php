            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('admin.menu.show', $arg) }}" class="btn btn-primary btn-xs mr-1">
                                <i class="fas fa-eye"></i>
                              </a>
                              <a href="{{ route('admin.menu.restore', $arg) }}" class="btn btn-success btn-xs mr-1">
                                <i class="fas fa-undo-alt"></i>
                              </a>
                              <form action="{{ route('admin.menu.destroy', $arg) }}" method="POST" class="d-inline">
                                @csrf
                                @method('delete')
